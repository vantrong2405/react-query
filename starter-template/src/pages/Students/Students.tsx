...
export default function Students() {
  ...
  const { data, isLoading } = useQuery(
    {
      queryKey: ['students', _page],//Khi page change thì queryFn gọi lại
      queryFn: () => getStudent(_page, 10)
    }
  )
            ...
            <table className='w-full text-left text-sm text-gray-500 dark:text-gray-400'>
              ...
              <tbody>
                {data?.data.map((student) => (
                  <tr className='border-b bg-white hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-600' key={student.id}>
